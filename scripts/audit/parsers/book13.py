#!/usr/bin/env python3
"""[별책13] 미술과 교육과정 PDF → 원문 구조화 JSON (SPEC.md 구조).

CLI : python3 book13.py --pdf <PDF경로> [--hwp <HWP경로>] --out <출력JSON>
...
BOOK_NO = 13
MANUAL_NOTES = [
    "미술 해설 불릿은 원문이 '• [코드] 성취기준은 …'(‘이’ 없음) 형태 — 정본의 '이 성취기준은 …'과 다르나 원문 그대로 수록"
]
