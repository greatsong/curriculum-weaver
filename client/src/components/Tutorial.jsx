...
const STEPS = [
  {
    ...
    lines: [
      ...
      { text: 'TADDs-DIE 모형으로 융합 수업을 설계할 수 있어요.' },
      { text: '' },
      { text: '설계 원리에 기반한 AI가' },
  ...
  {
    title: 'TADDs-DIE 설계 모형',
    badge: '3',
    // image: '/images/tutorial/cw-03-stages.png',
    lines: [
      { text: '협력적 수업 설계를 5단계 10하위단계로 진행해요.', highlight: true },
      { text: '' },
      { text: 'T  팀 준비 — 비전·방향 설정, 환경 조성', icon: 'invite' },
      { text: 'A  분석 — 주제 선정, 내용·역량 분석', icon: 'search' },
      { text: 'Ds 설계 — 교수학습·평가 활동, 지원 설계', icon: 'build' },
      { text: 'DI 개발·실행 — 자료 개발, 수업 실행', icon: 'rocket' },
      { text: 'E  성찰·평가 — 수시 환류, 종합평가', icon: 'refresh' },
      { text: '' },
